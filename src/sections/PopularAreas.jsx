      ...
      <div>
        <div className="flex justify-between max-lg:flex-col gap-5 items-center">
          <div className="flex flex-col gap-5">
            <p data-aos="fade-right" className="text-lg text-red-500 ">POPULAR AREAS</p>
            <h1 data-aos="fade-right" className="text-4xl font-semibold ">
              Explore most Popular Areas
            </h1>
          </div>
          <div data-aos='fade-left' className="flex max-lg:flex-col flex-wrap gap-5 flex-1">
            <img
              data-aos="zoom-in"
        ...
        <div className="flex max-lg:flex-col max-lg:items-center gap-4  justify-around pt-20">
          <div data-aos="fade-up" data-aos-delay="200" className="flex items-center gap-7">
          ...
          <div data-aos="fade-up" data-aos-delay="400" className="flex  items-center gap-7">
          ...
          <div data-aos="fade-up" data-aos-delay="600" className="flex items-center gap-7">
