...
const ServiceCard = ({ icon, desc, title , darkMode}) => {
  ...
  return (
    <div  data-aos="fade-up" className={`flex flex-col justify-center gap-4 p-9 rounded-xl border-b-4 border-red-500  ${darkMode? "bg-slate-900 text-white" : "bg-red-100"}`}>
